...
## Plans for Predict MPG

Visit the Predict MPG app at http://shereenjones.shinyapps.io/pa1_app.

Planned updates to Predict MPG include:

1. Adding the number of features used to predict mpg for a better prediction.
2. Allow users a 'refresh' option to reset default values.
3. Allow users the ability to select the variables they have and facilitate prediction using only those variables.
4. Add a graph that show how the selected vehicle specs stack up against the sample of data available
